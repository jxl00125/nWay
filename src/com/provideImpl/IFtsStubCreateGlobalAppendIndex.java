...
public class IFtsStubCreateGlobalAppendIndex {

	static Logger logger = Logger.getLogger(IFtsStubCreateGlobalAppendIndex.class);
	...
	public String createGlobalIndex(String viewname, String key) {
		...
		Date end = new Date();
		logger.info("创建索引結束" + (end.getTime() - start.getTime())
				+ " total milliseconds");
	...
	private String createIndex(String viewname) {
		...
		try {
			...
			for (int i=1;i<=page ;i++) {
				...
				new CreateAppendIndexThread(viewname,nsql,iw).execute();
	...
	class CreateAppendIndexThread {

		private String viewname;
		private String sql;
		private IndexWriter iw ;
		
		public CreateAppendIndexThread(String viewname,String sql,IndexWriter iw ){
